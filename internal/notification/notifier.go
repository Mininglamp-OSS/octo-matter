...
type Notifier interface {
	...
	// NotifyCommentAdded tells assignees + creator + participants about a new comment.
	NotifyCommentAdded(matter *model.Matter, actorID, actorName string, assigneeIDs, participantIDs []string)
}
...
func (Noop) NotifyCommentAdded(_ *model.Matter, _, _ string, _, _ []string)  {}
